                    ...
                    <fwb-modal v-if="isShowModal" @close="closeModal" class="w-full max-w-md mx-auto">
                            ...
                            <template #footer>
                                <div class="flex flex-col sm:flex-row sm:justify-between space-y-3 sm:space-y-0">
                                    <fwb-button @click="clearcart" color="alternative"
                                        :disabled="cartarrya.length === 0" class="w-full sm:w-auto">
                                        Clear
                                    </fwb-button>
                                    ...
                                    <fwb-button color="green" :disabled="cartarrya.length === 0"
                                        @click="redirectpayement" class="w-full sm:w-auto inline-flex items-center justify-center">
                                        <template #prefix>
