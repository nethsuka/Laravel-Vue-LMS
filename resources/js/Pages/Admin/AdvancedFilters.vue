            ...
            <div class="py-12">
                <div class="max-w-6xl mx-auto sm:px-6 lg:px-8" :style="{ overflowY: 'auto', maxHeight: '85vh' }">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-6 py-3 mb-4">
                        <div class="p-10">
                            <fwb-heading tag="h4" class="mb-10">Advanced Student Filters</fwb-heading>
                            ...
                            <div class="mt-4 space-x-4 mb-8">
                                <fwb-heading class="text-sm mb-3">Classes</fwb-heading>
                            ...
                            <div class="mt-4 space-x-4 mb-10">
                                <fwb-heading class="text-sm mb-3">Payment Status</fwb-heading>
                                <div class="flex flex-wrap gap-4 mt-2">
